...
function _toConsumableArray(arr) { if (Array.isArray(arr)) { for (var i = 0, arr2 = Array(arr.length); i < arr.length; i++) { arr2[i] = arr[i]; } return arr2; } else { return Array.from(arr); } } //import React from 'react';
...
var store = createStore(combineReducers({ todos: todos }), applyMiddleware());
...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(2), __webpack_require__(5), __webpack_require__(6), __webpack_require__(3)))
...
var _dec, _class; //import React from 'react';
// import $ from 'jquery';
...
var Tpl = (_dec = (0, _reactRedux.connect)(mapStateToProps, mapDispatchToProps), _dec(_class = function (_React$Component) {
  _inherits(Tpl, _React$Component);

  function Tpl(props) {
    _classCallCheck(this, Tpl);

    return _possibleConstructorReturn(this, (Tpl.__proto__ || Object.getPrototypeOf(Tpl)).call(this, props));
  }
